#!/usr/bin/env python3
# Author ID: ssalimi19_seneca

class Student:
    # Define the name and number when a student object
    # is created, ex. student1 = Student('john', 025969102)
    ...
    # Calculate the grade point average of all courses
    # and return a string
    def displayGPA(self):
        gpa = 0.0
    ...
    # Return a list of course that the student passed
    # (not a 0.0 grade)
